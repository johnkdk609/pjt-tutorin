    ...
    <div class="content">
      <div class="inputs">
        ...
        <div>
          ...
          <input
            type="text"
            placeholder="닉네임 (다른 사용자에게 보여지는 이름입니다.)"
        ...
        <div>
          ...
          <input
            type="text"
            placeholder="전화번호 ( - 제외)"
            v-model="userStore.user.phoneNum" />
        </div>
        <div v-if="loginStore.loginUser.status===2">
          ...
          <input
            type="text"
            placeholder="계좌 번호 (멘토로 답변 완료 시 입금될 계좌번호입니다.)" />
        </div>
        <div v-if="loginStore.loginUser.status===2">
          <span>상담 금액&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
          <input type="text" placeholder="상담 금액 (멘토의 상담 금액입니다)" />
        </div>
        <div>
          <span>이미지 변경&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
          <input
...
<style scoped>
.content {
  display: flex; /* flexbox를 사용하여 inputs와 buttons를 같은 줄에 배치 */
  align-items: flex-end; /* buttons를 아래쪽에 정렬 */
...
.buttons {
  flex: 1; /* buttons 영역이 좁게 설정됨 */
  display: flex;
  flex-direction: column;
  align-items: flex-end; /* 버튼들을 왼쪽에 정렬 */
  align-self: flex-end; /* buttons를 아래쪽에 정렬 */
}
